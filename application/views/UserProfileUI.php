				...
				<?php
		            ...
		            if(mysql_num_rows($res)==0){
						...
						foreach ($wishlist as $row) {
							...
							echo '<div class="row coll"><a href="'.base_url("place/".$row->place_name.'').'">';
							...
							echo $row->city;
							echo '</div></a><div class="col-lg-2"><span id="'.$row->id_collect.'" class="fa fa-heart iconcol w"></span></div>';
							echo '</div>';
						}
					}
				?>
				...
				<?php
		            ...
		            if(mysql_num_rows($res)==0){
						...
						foreach ($visited as $row) {
							...
							echo '<div class="tuffyh3a">'.$row->place_name.'</div>';
							echo $row->city;
							echo '</div></a><div class="col-lg-2"><span id="'.$row->id_collect.'" class="fa fa-check-circle iconcol a"></span></div>';
							echo '</div>';
						}
					}
				?>
