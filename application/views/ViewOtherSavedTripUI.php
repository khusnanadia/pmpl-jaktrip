		...
		<div class="col-lg-6" >
			...
			<div style="margin-left: 40px; margin-bottom: 80px;">
				...
				else
				{
					...
					echo "<td height='30px' width='350px' class='tuffyh3a'>".$place_name[$indexpertamaKali]."</td><td><a href=#>".$hasvisited."</a></td>";
					echo "</tr>";
					echo "<tr>";
					...
					//	echo $i;
						...
						if($place_name[$i] != "terhapus" && $i>0)
						{
							...
							echo "<td height='30px' width='350px' class='tuffyh3a'>".$place_name[$i]."</td><td><a href=#>".$hasvisited."</a></td>";
							echo "</tr>";
							echo "<tr>";
			...
			<a href="<?php echo base_url().'profile/'.$user; ?>"><button class="btn btn-warning" type="submit" style="font-size: 14px; margin-bottom: 80px; float: right; margin-right: 40px;">BACK TO USER PAGE</button></a>
		</div>
